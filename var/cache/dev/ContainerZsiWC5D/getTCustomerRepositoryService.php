...
// Returns the private 'App\Repository\TCustomerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TCustomerRepository.php';

return $this->privates['App\\Repository\\TCustomerRepository'] = new \App\Repository\TCustomerRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
